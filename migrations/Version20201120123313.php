 ...
 */
final class Version20201120123313 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('INSERT INTO user SELECT id, username, "[]", password, name as first_name, email, enabled as activated, last_login FROM fos_user');
